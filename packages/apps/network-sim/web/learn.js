...
const learnCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '📜', title: 'XSS', desc: 'Cross-Site Scripting : injection de JavaScript malveillant dans une page web. Permet le vol de cookies, le détournement de session ou la redirection vers un site malveillant.', scenario: 'pentest' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '📱', title: '2FA', desc: 'L\'authentification à deux facteurs exige un second élément en plus du mot de passe : code OTP, clé FIDO2, ou notification push. Bloque 99 % des vols de credentials. Testez : activez 2FA puis lancez Phishing pour voir la protection en phase 5.', scenario: 'phishing-scenario' },
